...
public class GeneralProductDownloader {
...
//            }
            ...
            for (Element e : consPerClientElement) {
                String tmp = e.text().substring(0, 4);
                switch (tmp) {
                    case "Curr":
                        quality = StringConvertor.convertToDouble(e.text());
                        break;
                    case "Cons":
                    case "Requ":
                        consPerClient = StringConvertor.convertToInt(e.text());
                        break;
                    case "Quan":
                        quantity = StringConvertor.convertToInt(e.text());
                        break;
                }
            }
